...
const ContentAbout = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center">
      <div
        className={`flex flex-col rounded-2xl overflow-hidden w-[25rem] h-[30rem] mt-10 ml-10 mr-10
       ${
         activeIndex == 0
           ? ""
           : "fixed opacity-0 md:opacity-100 transition-opacity duration-300"
       } md:flex`}
      >
      ...
      <button className="md:hidden" onClick={() => toggleIndex()}>
        v
      </button>
    </div>
  );
